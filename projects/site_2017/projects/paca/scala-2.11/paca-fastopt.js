...
/** @constructor */
var $c_Lnet_hangyas_paca_Main$ = (function() {
  $c_O.call(this);
  this.ctx$1 = null;
  this.canvas$1 = null;
  this.width$1 = 0;
  ...
  this.imgData$1 = null;
  this.pic$1 = null;
  this.flowloop$1 = null;
  this.paintloop$1 = null
});
$c_Lnet_hangyas_paca_Main$.prototype = new $h_O();
$c_Lnet_hangyas_paca_Main$.prototype.constructor = $c_Lnet_hangyas_paca_Main$;
/** @constructor */
var $h_Lnet_hangyas_paca_Main$ = (function() {
  /*<skip>*/
});
$h_Lnet_hangyas_paca_Main$.prototype = $c_Lnet_hangyas_paca_Main$.prototype;
$c_Lnet_hangyas_paca_Main$.prototype.init___ = (function() {
  $n_Lnet_hangyas_paca_Main$ = this;
  this.ctx$1 = null;
  this.canvas$1 = null;
  this.width$1 = 800;
  this.height$1 = 600;
  ...
  this.imgData$1 = null;
  this.pic$1 = null;
  this.flowloop$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
    try {
      $m_Lnet_hangyas_paca_Main$().pic$1.flow__V();
      var this$1 = $m_Lnet_hangyas_paca_Main$().pic$1.active$1;
      if ($s_sc_TraversableOnce$class__nonEmpty__sc_TraversableOnce__Z(this$1)) {
        return $uI($g["setTimeout"]((function(f) {
          return (function() {
            return f.apply__O()
          })
        })($m_Lnet_hangyas_paca_Main$().flowloop$1), 1.0))
      } else {
        return (void 0)
      }
    } catch (e) {
  ...
  this.paintloop$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function() {
    var qual$1 = $m_Lnet_hangyas_paca_Main$().ctx$1;
    var x$1 = $m_Lnet_hangyas_paca_Main$().imgData$1;
    qual$1["putImageData"](x$1, 0.0, 0.0);
    if (($m_Lnet_hangyas_paca_Main$().scale$1 !== 1)) {
      var qual$2 = $m_Lnet_hangyas_paca_Main$().ctx$1;
      var x$8 = $m_Lnet_hangyas_paca_Main$().canvas$1;
      var x$11 = $imul($m_Lnet_hangyas_paca_Main$().width$1, $m_Lnet_hangyas_paca_Main$().scale$1);
      var x$12 = $imul($m_Lnet_hangyas_paca_Main$().height$1, $m_Lnet_hangyas_paca_Main$().scale$1);
      qual$2["drawImage"](x$8, 0.0, 0.0, x$11, x$12)
    }
  }));
  return this
});
$c_Lnet_hangyas_paca_Main$.prototype.main__I__Z__V = (function(scale, blur) {
  $m_Lnet_hangyas_paca_Main$().scale$1 = scale;
  this.width$1 = $uI($g["window"]["innerWidth"]);
  this.height$1 = $uI($g["window"]["innerHeight"]);
  this.canvas$1 = $g["document"]["getElementById"]("display");
  this.canvas$1["width"] = this.width$1;
  this.canvas$1["height"] = this.height$1;
  this.ctx$1 = this.canvas$1["getContext"]("2d");
  this.ctx$1["imageSmoothingEnabled"] = false;
  this.ctx$1["webkitImageSmoothingEnabled"] = false;
  this.ctx$1["mozImageSmoothingEnabled"] = false;
  this.ctx$1["fillStyle"] = "#fff";
  this.ctx$1["fillRect"](0.0, 0.0, this.width$1, this.height$1);
  this.ctx$1["fillStyle"] = "#000";
  this.canvas$1["onmousedown"] = (function(scale$1) {
    return (function(e$2) {
      var p = new $c_Lnet_hangyas_paca_Point().init___I__I(((($uD(e$2["clientX"]) | 0) / scale$1) | 0), ((($uD(e$2["clientY"]) | 0) / scale$1) | 0));
      return $as_scm_Queue($m_Lnet_hangyas_paca_Main$().pic$1.activeBuf$1.$$plus$eq__O__scm_MutableList(p))
    })
  })(scale);
  this.imgData$1 = this.ctx$1["getImageData"](0.0, 0.0, ((this.width$1 / scale) | 0), ((this.height$1 / scale) | 0));
  this.pic$1 = new $c_Lnet_hangyas_paca_Picture().init___I__I__sjs_js_Array__Z(((this.width$1 / scale) | 0), ((this.height$1 / scale) | 0), this.imgData$1["data"], blur);
  $g["setTimeout"]((function(f) {
    return (function() {
      return f.apply__O()
    })
  })(this.flowloop$1), 0.0);
  $g["setInterval"]((function(f$1) {
    return (function() {
      return f$1.apply__O()
    })
  })(this.paintloop$1), 66.0)
});
$c_Lnet_hangyas_paca_Main$.prototype.$$js$exported$meth$main__O__O = (function(namedParams) {
  var namedArg$0 = namedParams["scale"];
  var namedArg$1 = namedParams["blur"];
  if ((namedArg$0 === (void 0))) {
    var prepnamedArg$0 = 1
  } else if ((namedArg$0 === null)) {
    var prepnamedArg$0;
    throw "Found null, expected Int"
  } else {
    var prepnamedArg$0 = $uI(namedArg$0)
  };
  if ((namedArg$1 !== (void 0))) {
    if ((namedArg$1 === null)) {
      var prepnamedArg$1;
      throw "Found null, expected Boolean"
    } else {
      var prepnamedArg$1 = $uZ(namedArg$1)
    }
  } else {
    var prepnamedArg$1 = false
  };
  this.main__I__Z__V(prepnamedArg$0, prepnamedArg$1)
});
$c_Lnet_hangyas_paca_Main$.prototype["main"] = (function(arg$1) {
  var preparg$1 = arg$1;
  return this.$$js$exported$meth$main__O__O(preparg$1)
});
var $d_Lnet_hangyas_paca_Main$ = new $ClassTypeData({
  Lnet_hangyas_paca_Main$: 0
}, false, "net.hangyas.paca.Main$", {
  Lnet_hangyas_paca_Main$: 1,
  O: 1
});
$c_Lnet_hangyas_paca_Main$.prototype.$classData = $d_Lnet_hangyas_paca_Main$;
var $n_Lnet_hangyas_paca_Main$ = (void 0);
var $m_Lnet_hangyas_paca_Main$ = (function() {
  if ((!$n_Lnet_hangyas_paca_Main$)) {
    $n_Lnet_hangyas_paca_Main$ = new $c_Lnet_hangyas_paca_Main$().init___()
  };
  return $n_Lnet_hangyas_paca_Main$
});
$e["Main"] = $m_Lnet_hangyas_paca_Main$;
/** @constructor */
var $c_Lnet_hangyas_paca_Picture = (function() {
  $c_O.call(this);
  this.width$1 = 0;
  this.height$1 = 0;
  this.imgData$1 = null;
  ...
  this.data$1 = null;
  this.active$1 = null;
  this.activeBuf$1 = null
});
$c_Lnet_hangyas_paca_Picture.prototype = new $h_O();
$c_Lnet_hangyas_paca_Picture.prototype.constructor = $c_Lnet_hangyas_paca_Picture;
/** @constructor */
var $h_Lnet_hangyas_paca_Picture = (function() {
  /*<skip>*/
});
$h_Lnet_hangyas_paca_Picture.prototype = $c_Lnet_hangyas_paca_Picture.prototype;
$c_Lnet_hangyas_paca_Picture.prototype.net$hangyas$paca$Picture$$isActive__Lnet_hangyas_paca_Point__Z = (function(p) {
  var nonLocalReturnKey2 = new $c_O().init___();
  try {
    if ((!this.net$hangyas$paca$Picture$$isInner__Lnet_hangyas_paca_Point__Z(p))) {
      return false
    };
    var xs = $m_Lnet_hangyas_paca_Point$().dirs$1;
    var i = 0;
    var len = xs.u["length"];
    while ((i < len)) {
      var index = i;
      var arg1 = xs.u[index];
      var d = $as_Lnet_hangyas_paca_Point(arg1);
      var a = p.$$plus__Lnet_hangyas_paca_Point__Lnet_hangyas_paca_Point(d);
      if ((this.net$hangyas$paca$Picture$$isInner__Lnet_hangyas_paca_Point__Z(a) && (this.get__Lnet_hangyas_paca_Point__Lnet_hangyas_paca_Pixel(a) === $m_Lnet_hangyas_paca_Pixel$().default$1))) {
...
$c_Lnet_hangyas_paca_Picture.prototype.get__Lnet_hangyas_paca_Point__Lnet_hangyas_paca_Pixel = (function(p) {
  return this.data$1.u[p.x$1].u[p.y$1]
});
$c_Lnet_hangyas_paca_Picture.prototype.init___I__I__sjs_js_Array__Z = (function(width, height, imgData, blur) {
  this.width$1 = width;
  this.height$1 = height;
  this.imgData$1 = imgData;
  this.blur$1 = blur;
  $m_s_Array$();
  var evidence$10 = $m_s_reflect_ClassTag$().apply__jl_Class__s_reflect_ClassTag($d_Lnet_hangyas_paca_Pixel.getClassOf());
  var evidence$14 = $m_s_reflect_ClassTag$().apply__jl_Class__s_reflect_ClassTag($m_sr_ScalaRunTime$().arrayClass__jl_Class__jl_Class(evidence$10.runtimeClass__jl_Class()));
  var b = $m_scm_ArrayBuilder$().make__s_reflect_ClassTag__scm_ArrayBuilder(evidence$14);
  b.sizeHint__I__V(width);
  var i = 0;
  while ((i < width)) {
    var arg1 = i;
    var b$1 = $m_scm_ArrayBuilder$().make__s_reflect_ClassTag__scm_ArrayBuilder(evidence$10);
    b$1.sizeHint__I__V(height);
    var i$1 = 0;
    while ((i$1 < height)) {
      b$1.$$plus$eq__O__scm_Builder($m_Lnet_hangyas_paca_Pixel$().default$1);
      i$1 = ((1 + i$1) | 0)
    };
    b.$$plus$eq__O__scm_Builder(b$1.result__O());
    i = ((1 + i) | 0)
  };
  this.data$1 = $asArrayOf_Lnet_hangyas_paca_Pixel($asArrayOf_O(b.result__O(), 1), 2);
  var array = [new $c_Lnet_hangyas_paca_Point().init___I__I(((width / 2) | 0), ((height / 2) | 0))];
  if (($uI(array["length"]) === 0)) {
    var jsx$1 = new $c_scm_HashSet().init___()
  } else {
    var b$2 = new $c_scm_GrowingBuilder().init___scg_Growable(new $c_scm_HashSet().init___());
    matchEnd4: {
      var i$2 = 0;
  ...
  this.active$1 = $as_scm_HashSet(jsx$1);
  this.activeBuf$1 = new $c_scm_Queue().init___();
  return this
});
$c_Lnet_hangyas_paca_Picture.prototype.set__I__I__Lnet_hangyas_paca_Pixel__V = (function(x, y, px) {
  this.data$1.u[x].u[y] = px;
  var i = $imul(4, (($imul(y, this.width$1) + x) | 0));
  this.imgData$1[i] = px.r$1;
  i = ((1 + i) | 0);
  this.imgData$1[i] = px.g$1;
  i = ((1 + i) | 0);
  this.imgData$1[i] = px.b$1;
  i = ((1 + i) | 0)
});
$c_Lnet_hangyas_paca_Picture.prototype.net$hangyas$paca$Picture$$getNext__Lnet_hangyas_paca_Point__Lnet_hangyas_paca_Point = (function(p) {
  var r = null;
  do {
    var jsx$1 = $m_Lnet_hangyas_paca_Point$().dirs$1;
    var this$1 = $m_Lnet_hangyas_paca_Picture$().rand$1;
    var n = $m_Lnet_hangyas_paca_Point$().dirs$1.u["length"];
    r = p.$$plus__Lnet_hangyas_paca_Point__Lnet_hangyas_paca_Point(jsx$1.u[this$1.self$1.nextInt__I__I(n)])
  } while (((!this.net$hangyas$paca$Picture$$isInner__Lnet_hangyas_paca_Point__Z(r)) || (this.get__Lnet_hangyas_paca_Point__Lnet_hangyas_paca_Pixel(r) !== $m_Lnet_hangyas_paca_Pixel$().default$1)));
  return r
});
$c_Lnet_hangyas_paca_Picture.prototype.net$hangyas$paca$Picture$$isInner__Lnet_hangyas_paca_Point__Z = (function(p) {
  return ((((p.x$1 >= 0) && (p.y$1 >= 0)) && (p.x$1 < this.width$1)) && (p.y$1 < this.height$1))
});
$c_Lnet_hangyas_paca_Picture.prototype.flow__V = (function() {
  var nonLocalReturnKey1 = new $c_O().init___();
  try {
    var this$2 = this.active$1;
    if ((this$2.tableSize$5 > 1000)) {
      var end = 1000
    } else {
      var this$3 = this.active$1;
      var end = this$3.tableSize$5
    };
    var isEmpty$4 = (end <= 0);
    ...
    while ((i !== terminalElement$4)) {
      var this$6 = this.active$1;
      if ($s_sc_SetLike$class__isEmpty__sc_SetLike__Z(this$6)) {
        throw new $c_sr_NonLocalReturnControl$mcV$sp().init___O__sr_BoxedUnit(nonLocalReturnKey1, (void 0))
      };
      var this$7 = this.active$1;
      var i$2 = new $c_scm_FlatHashTable$$anon$1().init___scm_FlatHashTable(this$7);
      var this$10 = $m_Lnet_hangyas_paca_Picture$().rand$1;
      var this$9 = this.active$1;
      var n = this$9.tableSize$5;
      var end$1 = this$10.self$1.nextInt__I__I(n);
      ...
      while ((i$3 !== terminalElement$4$1)) {
        var arg1 = i$3;
        $as_Lnet_hangyas_paca_Point(i$2.next__O());
        count$1 = ((1 + count$1) | 0);
        i$3 = ((1 + i$3) | 0)
      };
      var ap = $as_Lnet_hangyas_paca_Point(i$2.next__O());
      var p = this.net$hangyas$paca$Picture$$getNext__Lnet_hangyas_paca_Point__Lnet_hangyas_paca_Point(ap);
      if (this.blur$1) {
        var px = this.get__Lnet_hangyas_paca_Point__Lnet_hangyas_paca_Pixel(ap).child__sci_List__Lnet_hangyas_paca_Pixel(this.net$hangyas$paca$Picture$$collect__Lnet_hangyas_paca_Point__sc_Seq__sci_List(p, $m_s_Predef$().wrapRefArray__AO__scm_WrappedArray($m_Lnet_hangyas_paca_Point$().dirs$1)));
        this.set__I__I__Lnet_hangyas_paca_Pixel__V(p.x$1, p.y$1, px)
      } else {
        var px$1 = this.get__Lnet_hangyas_paca_Point__Lnet_hangyas_paca_Pixel(ap).child__Lnet_hangyas_paca_Pixel();
        this.set__I__I__Lnet_hangyas_paca_Pixel__V(p.x$1, p.y$1, px$1)
      };
      if (this.net$hangyas$paca$Picture$$isActive__Lnet_hangyas_paca_Point__Z(p)) {
        this.active$1.$$plus$eq__O__scm_HashSet(p)
      };
      var xs = $m_Lnet_hangyas_paca_Point$().dirs$1;
      var i$4 = 0;
      ...
      while ((i$4 < len$2)) {
        var index = i$4;
        var arg1$1 = xs.u[index];
        var d = $as_Lnet_hangyas_paca_Point(arg1$1);
        var a = p.$$plus__Lnet_hangyas_paca_Point__Lnet_hangyas_paca_Point(d);
        if ((!this.net$hangyas$paca$Picture$$isActive__Lnet_hangyas_paca_Point__Z(a))) {
          this.active$1.$$minus$eq__O__scm_HashSet(a)
        };
        i$4 = ((1 + i$4) | 0)
      };
      count = ((1 + count) | 0);
    ...
    while (true) {
      var this$16 = this.activeBuf$1;
      if ($s_sc_TraversableOnce$class__nonEmpty__sc_TraversableOnce__Z(this$16)) {
        this.active$1.$$plus$eq__O__scm_HashSet(this.activeBuf$1.dequeue__O())
      } else {
        break
      }
    }
...
$c_Lnet_hangyas_paca_Picture.prototype.net$hangyas$paca$Picture$$collect__Lnet_hangyas_paca_Point__sc_Seq__sci_List = (function(from, dirs) {
  var elem = new $c_scm_MutableList().init___();
  var r = new $c_sr_ObjectRef().init___O(elem);
  dirs.foreach__F1__V(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer, from$1, r$2) {
    return (function(d$2) {
      var d = $as_Lnet_hangyas_paca_Point(d$2);
      var p = from$1.$$plus__Lnet_hangyas_paca_Point__Lnet_hangyas_paca_Point(d);
      return ((arg$outer.net$hangyas$paca$Picture$$isInner__Lnet_hangyas_paca_Point__Z(p) && (arg$outer.get__Lnet_hangyas_paca_Point__Lnet_hangyas_paca_Pixel(p) !== $m_Lnet_hangyas_paca_Pixel$().default$1)) ? $as_scm_MutableList(r$2.elem$1).$$plus$eq__O__scm_MutableList(arg$outer.get__Lnet_hangyas_paca_Point__Lnet_hangyas_paca_Pixel(p)) : (void 0))
    })
  })(this, from, r)));
  var this$2 = $as_scm_MutableList(r.elem$1);
  var this$3 = this$2.first0$5;
  var this$4 = $m_sci_List$();
  var cbf = this$4.ReusableCBFInstance$2;
  return $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(this$3, cbf))
});
var $d_Lnet_hangyas_paca_Picture = new $ClassTypeData({
  Lnet_hangyas_paca_Picture: 0
}, false, "net.hangyas.paca.Picture", {
  Lnet_hangyas_paca_Picture: 1,
  O: 1
});
$c_Lnet_hangyas_paca_Picture.prototype.$classData = $d_Lnet_hangyas_paca_Picture;
/** @constructor */
var $c_Lnet_hangyas_paca_Picture$ = (function() {
  $c_O.call(this);
  this.rand$1 = null
...
$h_Lnet_hangyas_paca_Picture$.prototype = $c_Lnet_hangyas_paca_Picture$.prototype;
$c_Lnet_hangyas_paca_Picture$.prototype.init___ = (function() {
  $n_Lnet_hangyas_paca_Picture$ = this;
...
$c_Lnet_hangyas_paca_Picture$.prototype.$classData = $d_Lnet_hangyas_paca_Picture$;
var $n_Lnet_hangyas_paca_Picture$ = (void 0);
var $m_Lnet_hangyas_paca_Picture$ = (function() {
  if ((!$n_Lnet_hangyas_paca_Picture$)) {
    $n_Lnet_hangyas_paca_Picture$ = new $c_Lnet_hangyas_paca_Picture$().init___()
  };
  return $n_Lnet_hangyas_paca_Picture$
});
/** @constructor */
...
var $s_sc_LinearSeqOptimized$class__foreach__sc_LinearSeqOptimized__F1__V = (function($$this, f) {
  var these = $$this;
...
var $s_sc_LinearSeqOptimized$class__drop__sc_LinearSeqOptimized__I__sc_LinearSeqOptimized = (function($$this, n) {
  var these = $$this;
  var count = n;
...
var $s_scm_LinkedListLike$class__isEmpty__scm_LinkedListLike__Z = (function($$this) {
  return ($$this.next$5 === $$this)
});
var $s_scm_LinkedListLike$class__apply__scm_LinkedListLike__I__O = (function($$this, n) {
...
var $s_scm_LinkedListLike$class__length0__p0__scm_LinkedListLike__scm_Seq__I__I = (function($$this, elem, acc) {
  _length0: while (true) {
...
var $s_scm_LinkedListLike$class__tail__scm_LinkedListLike__scm_Seq = (function($$this) {
...
var $s_scm_LinkedListLike$class__drop__scm_LinkedListLike__I__scm_Seq = (function($$this, n) {
  var i = 0;
...
var $s_scm_LinkedListLike$class__foreach__scm_LinkedListLike__F1__V = (function($$this, f) {
  var these = $$this;
  while (true) {
    var this$1 = these;
    if ($s_sc_TraversableOnce$class__nonEmpty__sc_TraversableOnce__Z(this$1)) {
...
var $s_scm_LinkedListLike$class__head__scm_LinkedListLike__O = (function($$this) {
...
var $d_scm_WrappedArray$ = new $ClassTypeData({
  scm_WrappedArray$: 0
...
$c_sr_ScalaRunTime$.prototype.arrayClass__jl_Class__jl_Class = (function(clazz) {
  return (((clazz !== null) && (clazz === $d_V.getClassOf())) ? $d_sr_BoxedUnit.getArrayOf().getClassOf() : $objectGetClass($m_jl_reflect_Array$().newInstance__jl_Class__I__O(clazz, 0)))
});
...
/** @constructor */
var $c_Lnet_hangyas_paca_Pixel$ = (function() {
  $c_O.call(this);
  this.default$1 = null
});
$c_Lnet_hangyas_paca_Pixel$.prototype = new $h_O();
$c_Lnet_hangyas_paca_Pixel$.prototype.constructor = $c_Lnet_hangyas_paca_Pixel$;
/** @constructor */
var $h_Lnet_hangyas_paca_Pixel$ = (function() {
  /*<skip>*/
});
$h_Lnet_hangyas_paca_Pixel$.prototype = $c_Lnet_hangyas_paca_Pixel$.prototype;
$c_Lnet_hangyas_paca_Pixel$.prototype.init___ = (function() {
  $n_Lnet_hangyas_paca_Pixel$ = this;
  this.default$1 = new $c_Lnet_hangyas_paca_Pixel().init___I__I__I(155, 155, 155);
  return this
});
var $d_Lnet_hangyas_paca_Pixel$ = new $ClassTypeData({
  Lnet_hangyas_paca_Pixel$: 0
}, false, "net.hangyas.paca.Pixel$", {
  Lnet_hangyas_paca_Pixel$: 1,
  O: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1
});
$c_Lnet_hangyas_paca_Pixel$.prototype.$classData = $d_Lnet_hangyas_paca_Pixel$;
var $n_Lnet_hangyas_paca_Pixel$ = (void 0);
var $m_Lnet_hangyas_paca_Pixel$ = (function() {
  if ((!$n_Lnet_hangyas_paca_Pixel$)) {
    $n_Lnet_hangyas_paca_Pixel$ = new $c_Lnet_hangyas_paca_Pixel$().init___()
  };
  return $n_Lnet_hangyas_paca_Pixel$
});
/** @constructor */
var $c_Lnet_hangyas_paca_Point$ = (function() {
  $c_O.call(this);
  this.dirs$1 = null
});
$c_Lnet_hangyas_paca_Point$.prototype = new $h_O();
$c_Lnet_hangyas_paca_Point$.prototype.constructor = $c_Lnet_hangyas_paca_Point$;
/** @constructor */
var $h_Lnet_hangyas_paca_Point$ = (function() {
  /*<skip>*/
});
$h_Lnet_hangyas_paca_Point$.prototype = $c_Lnet_hangyas_paca_Point$.prototype;
$c_Lnet_hangyas_paca_Point$.prototype.init___ = (function() {
  $n_Lnet_hangyas_paca_Point$ = this;
  this.dirs$1 = $asArrayOf_Lnet_hangyas_paca_Point($m_s_Array$().apply__sc_Seq__s_reflect_ClassTag__O(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lnet_hangyas_paca_Point().init___I__I(0, 1), new $c_Lnet_hangyas_paca_Point().init___I__I((-1), 0), new $c_Lnet_hangyas_paca_Point().init___I__I(0, (-1)), new $c_Lnet_hangyas_paca_Point().init___I__I(1, 0)]), $m_s_reflect_ClassTag$().apply__jl_Class__s_reflect_ClassTag($d_Lnet_hangyas_paca_Point.getClassOf())), 1);
  return this
});
var $d_Lnet_hangyas_paca_Point$ = new $ClassTypeData({
  Lnet_hangyas_paca_Point$: 0
}, false, "net.hangyas.paca.Point$", {
  Lnet_hangyas_paca_Point$: 1,
  O: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1
});
$c_Lnet_hangyas_paca_Point$.prototype.$classData = $d_Lnet_hangyas_paca_Point$;
var $n_Lnet_hangyas_paca_Point$ = (void 0);
var $m_Lnet_hangyas_paca_Point$ = (function() {
  if ((!$n_Lnet_hangyas_paca_Point$)) {
    $n_Lnet_hangyas_paca_Point$ = new $c_Lnet_hangyas_paca_Point$().init___()
  };
  return $n_Lnet_hangyas_paca_Point$
});
...
var $d_s_util_Random = new $ClassTypeData({
  s_util_Random: 0
...
$h_Lnet_hangyas_paca_Pixel.prototype = $c_Lnet_hangyas_paca_Pixel.prototype;
$c_Lnet_hangyas_paca_Pixel.prototype.productPrefix__T = (function() {
  return "Pixel"
});
$c_Lnet_hangyas_paca_Pixel.prototype.productArity__I = (function() {
  return 3
});
$c_Lnet_hangyas_paca_Pixel.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lnet_hangyas_paca_Pixel(x$1)) {
    var Pixel$1 = $as_Lnet_hangyas_paca_Pixel(x$1);
    return (((this.r$1 === Pixel$1.r$1) && (this.g$1 === Pixel$1.g$1)) && (this.b$1 === Pixel$1.b$1))
  } else {
    return false
  }
});
$c_Lnet_hangyas_paca_Pixel.prototype.$$plus$eq__Lnet_hangyas_paca_Pixel__V = (function(px) {
  this.r$1 = ((this.r$1 + $imul(px.r$1, px.r$1)) | 0);
  this.g$1 = ((this.g$1 + $imul(px.g$1, px.g$1)) | 0);
  this.b$1 = ((this.b$1 + $imul(px.b$1, px.b$1)) | 0)
});
$c_Lnet_hangyas_paca_Pixel.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.r$1;
...
$c_Lnet_hangyas_paca_Pixel.prototype.init___I__I__I = (function(r, g, b) {
  this.r$1 = r;
  this.g$1 = g;
  this.b$1 = b;
  return this
});
$c_Lnet_hangyas_paca_Pixel.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lnet_hangyas_paca_Pixel.prototype.child__sci_List__Lnet_hangyas_paca_Pixel = (function(n) {
  var r = new $c_Lnet_hangyas_paca_Pixel().init___I__I__I(0, 0, 0);
  var these = n;
  while ((!these.isEmpty__Z())) {
    var arg1 = these.head__O();
    var px = $as_Lnet_hangyas_paca_Pixel(arg1);
    r.$$plus$eq__Lnet_hangyas_paca_Pixel__V(px);
    var this$1 = these;
    these = this$1.tail__sci_List()
  };
  var div = $s_sc_LinearSeqOptimized$class__length__sc_LinearSeqOptimized__I(n);
  var a = ((r.r$1 / div) | 0);
  r.r$1 = ($uD($g["Math"]["sqrt"](a)) | 0);
  var a$1 = ((r.g$1 / div) | 0);
  r.g$1 = ($uD($g["Math"]["sqrt"](a$1)) | 0);
  var a$2 = ((r.b$1 / div) | 0);
  r.b$1 = ($uD($g["Math"]["sqrt"](a$2)) | 0);
  var this$5 = $m_Lnet_hangyas_paca_Picture$().rand$1;
  if ((this$5.self$1.nextDouble__D() < 0.25)) {
    var jsx$1 = r.r$1;
    var this$6 = $m_Lnet_hangyas_paca_Picture$().rand$1;
    r.r$1 = ((jsx$1 + (((-25) + this$6.self$1.nextInt__I__I(50)) | 0)) | 0)
  };
  var this$7 = $m_Lnet_hangyas_paca_Picture$().rand$1;
  if ((this$7.self$1.nextDouble__D() < 0.25)) {
    var jsx$2 = r.g$1;
    var this$8 = $m_Lnet_hangyas_paca_Picture$().rand$1;
    r.g$1 = ((jsx$2 + (((-25) + this$8.self$1.nextInt__I__I(50)) | 0)) | 0)
  };
  var this$9 = $m_Lnet_hangyas_paca_Picture$().rand$1;
  if ((this$9.self$1.nextDouble__D() < 0.25)) {
    var jsx$3 = r.b$1;
    var this$10 = $m_Lnet_hangyas_paca_Picture$().rand$1;
    r.b$1 = ((jsx$3 + (((-25) + this$10.self$1.nextInt__I__I(50)) | 0)) | 0)
  };
  return r
});
$c_Lnet_hangyas_paca_Pixel.prototype.hashCode__I = (function() {
  var acc = (-889275714);
...
$c_Lnet_hangyas_paca_Pixel.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
$c_Lnet_hangyas_paca_Pixel.prototype.child__Lnet_hangyas_paca_Pixel = (function() {
  var r = new $c_Lnet_hangyas_paca_Pixel().init___I__I__I(this.r$1, this.g$1, this.b$1);
  var this$1 = $m_Lnet_hangyas_paca_Picture$().rand$1;
  if ((this$1.self$1.nextDouble__D() < 0.25)) {
    var jsx$1 = r.r$1;
    var this$2 = $m_Lnet_hangyas_paca_Picture$().rand$1;
    r.r$1 = ((jsx$1 + (((-25) + this$2.self$1.nextInt__I__I(50)) | 0)) | 0)
  };
  var this$3 = $m_Lnet_hangyas_paca_Picture$().rand$1;
  if ((this$3.self$1.nextDouble__D() < 0.25)) {
    var jsx$2 = r.g$1;
    var this$4 = $m_Lnet_hangyas_paca_Picture$().rand$1;
    r.g$1 = ((jsx$2 + (((-25) + this$4.self$1.nextInt__I__I(50)) | 0)) | 0)
  };
  var this$5 = $m_Lnet_hangyas_paca_Picture$().rand$1;
  if ((this$5.self$1.nextDouble__D() < 0.25)) {
    var jsx$3 = r.b$1;
    var this$6 = $m_Lnet_hangyas_paca_Picture$().rand$1;
    r.b$1 = ((jsx$3 + (((-25) + this$6.self$1.nextInt__I__I(50)) | 0)) | 0)
  };
  return r
});
var $is_Lnet_hangyas_paca_Pixel = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_hangyas_paca_Pixel)))
});
var $as_Lnet_hangyas_paca_Pixel = (function(obj) {
  return (($is_Lnet_hangyas_paca_Pixel(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.hangyas.paca.Pixel"))
});
var $isArrayOf_Lnet_hangyas_paca_Pixel = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_hangyas_paca_Pixel)))
});
var $asArrayOf_Lnet_hangyas_paca_Pixel = (function(obj, depth) {
  return (($isArrayOf_Lnet_hangyas_paca_Pixel(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.hangyas.paca.Pixel;", depth))
});
var $d_Lnet_hangyas_paca_Pixel = new $ClassTypeData({
  Lnet_hangyas_paca_Pixel: 0
}, false, "net.hangyas.paca.Pixel", {
...
$h_Lnet_hangyas_paca_Point.prototype = $c_Lnet_hangyas_paca_Point.prototype;
$c_Lnet_hangyas_paca_Point.prototype.productPrefix__T = (function() {
  return "Point"
});
$c_Lnet_hangyas_paca_Point.prototype.productArity__I = (function() {
  return 2
});
$c_Lnet_hangyas_paca_Point.prototype.equals__O__Z = (function(x$1) {
  if ((this === x$1)) {
    return true
  } else if ($is_Lnet_hangyas_paca_Point(x$1)) {
    var Point$1 = $as_Lnet_hangyas_paca_Point(x$1);
    return ((this.x$1 === Point$1.x$1) && (this.y$1 === Point$1.y$1))
  } else {
    return false
  }
});
$c_Lnet_hangyas_paca_Point.prototype.productElement__I__O = (function(x$1) {
  switch (x$1) {
    case 0:
      {
        return this.x$1;
...
$c_Lnet_hangyas_paca_Point.prototype.init___I__I = (function(x, y) {
  this.x$1 = x;
  this.y$1 = y;
  return this
});
$c_Lnet_hangyas_paca_Point.prototype.toString__T = (function() {
  return $m_sr_ScalaRunTime$().$$undtoString__s_Product__T(this)
});
$c_Lnet_hangyas_paca_Point.prototype.$$plus__Lnet_hangyas_paca_Point__Lnet_hangyas_paca_Point = (function(p) {
  return new $c_Lnet_hangyas_paca_Point().init___I__I(((this.x$1 + p.x$1) | 0), ((this.y$1 + p.y$1) | 0))
});
$c_Lnet_hangyas_paca_Point.prototype.hashCode__I = (function() {
  var acc = (-889275714);
...
$c_Lnet_hangyas_paca_Point.prototype.productIterator__sc_Iterator = (function() {
  return new $c_sr_ScalaRunTime$$anon$1().init___s_Product(this)
});
var $is_Lnet_hangyas_paca_Point = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lnet_hangyas_paca_Point)))
});
var $as_Lnet_hangyas_paca_Point = (function(obj) {
  return (($is_Lnet_hangyas_paca_Point(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "net.hangyas.paca.Point"))
});
var $isArrayOf_Lnet_hangyas_paca_Point = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lnet_hangyas_paca_Point)))
});
var $asArrayOf_Lnet_hangyas_paca_Point = (function(obj, depth) {
  return (($isArrayOf_Lnet_hangyas_paca_Point(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lnet.hangyas.paca.Point;", depth))
});
var $d_Lnet_hangyas_paca_Point = new $ClassTypeData({
  Lnet_hangyas_paca_Point: 0
}, false, "net.hangyas.paca.Point", {
...
/** @constructor */
var $c_scm_LinkedListLike$$anon$1 = (function() {
  $c_sc_AbstractIterator.call(this);
  this.elems$2 = null
});
...
/** @constructor */
var $h_scm_LinkedListLike$$anon$1 = (function() {
  /*<skip>*/
});
...
var $d_scm_LinkedListLike$$anon$1 = new $ClassTypeData({
...
/** @constructor */
var $c_scm_MutableList$$anon$1 = (function() {
  $c_sc_AbstractIterator.call(this);
  this.elems$2 = null;
  this.count$2 = 0
});
...
/** @constructor */
var $h_scm_MutableList$$anon$1 = (function() {
  /*<skip>*/
});
...
var $d_scm_MutableList$$anon$1 = new $ClassTypeData({
...
/** @constructor */
var $c_sr_NonLocalReturnControl = (function() {
  $c_jl_Throwable.call(this);
  this.key$2 = null;
  this.value$f = null
});
...
/** @constructor */
var $h_sr_NonLocalReturnControl = (function() {
  /*<skip>*/
});
...
$c_sr_NonLocalReturnControl.prototype.value$mcV$sp__V = (function() {
  this.value__O()
});
...
$c_sr_NonLocalReturnControl.prototype.value$mcZ$sp__Z = (function() {
  return $uZ(this.value__O())
});
...
/** @constructor */
var $c_sr_NonLocalReturnControl$mcV$sp = (function() {
...
/** @constructor */
var $h_sr_NonLocalReturnControl$mcV$sp = (function() {
  /*<skip>*/
});
$h_sr_NonLocalReturnControl$mcV$sp.prototype = $c_sr_NonLocalReturnControl$mcV$sp.prototype;
$c_sr_NonLocalReturnControl$mcV$sp.prototype.value__O = (function() {
  return (void 0)
});
$c_sr_NonLocalReturnControl$mcV$sp.prototype.value$mcV$sp__V = (function() {
  /*<skip>*/
});
...
var $d_sr_NonLocalReturnControl$mcV$sp = new $ClassTypeData({
...
/** @constructor */
var $c_sr_NonLocalReturnControl$mcZ$sp = (function() {
  $c_sr_NonLocalReturnControl.call(this);
...
/** @constructor */
var $h_sr_NonLocalReturnControl$mcZ$sp = (function() {
  /*<skip>*/
});
$h_sr_NonLocalReturnControl$mcZ$sp.prototype = $c_sr_NonLocalReturnControl$mcZ$sp.prototype;
$c_sr_NonLocalReturnControl$mcZ$sp.prototype.value__O = (function() {
...
$c_sr_NonLocalReturnControl$mcZ$sp.prototype.value$mcZ$sp__Z = (function() {
  return this.value$mcZ$sp$f
});
var $d_sr_NonLocalReturnControl$mcZ$sp = new $ClassTypeData({
...
var $d_scm_LinkedList$ = new $ClassTypeData({
  scm_LinkedList$: 0
...
var $d_scm_MutableList$ = new $ClassTypeData({
  scm_MutableList$: 0
...
var $m_scm_MutableList$ = (function() {
...
var $d_scm_Queue$ = new $ClassTypeData({
  scm_Queue$: 0
...
//# sourceMappingURL=paca-fastopt.js.map
